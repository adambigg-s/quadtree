...
/*
    ...
    Cmdline:
        sokol-shdc -i ./src/shaders/line_shader.glsl -o ./src/compiled_shaders/line_shader.rs --slang hlsl5:wgsl:glsl430 -f sokol_rust
...
*/
pub const ATTR_LINE_I_POS: usize = 0;
pub const ATTR_LINE_I_COLOR: usize = 1;
...
/*
    ...
    {
        f_color = i_color;
        gl_Position = vec4(((i_pos / v_params_world[0].xy) * 2.0) - vec2(1.0), 0.0, 1.0);
    }

*/
pub const LINE_VS_SOURCE_GLSL430: [u8; 287] = [
    ...
    0x20,0x20,0x66,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x69,0x5f,0x63,0x6f,
    0x6c,0x6f,0x72,0x3b,0x0a,0x20,0x20,0x20,0x20,0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,
    0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x28,0x69,0x5f,
...
*/
pub const LINE_FS_SOURCE_GLSL430: [u8; 129] = [
...
/*
    ...
    {
        f_color = i_color;
        gl_Position = float4(((i_pos / _21_world_dims) * 2.0f) - 1.0f.xx, 0.0f, 1.0f);
    }
...
*/
pub const LINE_VS_SOURCE_HLSL5: [u8; 792] = [
    ...
    0x69,0x5f,0x70,0x6f,0x73,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,0x53,
    ...
    0x69,0x5f,0x70,0x6f,0x73,0x20,0x2f,0x20,0x5f,0x32,0x31,0x5f,0x77,0x6f,0x72,0x6c,
    ...
    0x29,0x0a,0x7b,0x0a,0x20,0x20,0x20,0x20,0x69,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,
    0x3d,0x20,0x73,0x74,0x61,0x67,0x65,0x5f,0x69,0x6e,0x70,0x75,0x74,0x2e,0x69,0x5f,
    0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x5f,0x70,0x6f,0x73,
...
*/
pub const LINE_FS_SOURCE_HLSL5: [u8; 420] = [
...
/*
    ...
    @vertex
    fn main(@location(1) i_color_param : vec3f, @location(0) i_pos_param : vec2f) -> main_out {
...
*/
pub const LINE_VS_SOURCE_WGSL: [u8; 893] = [
    ...
    0x72,0x69,0x76,0x61,0x74,0x65,0x3e,0x20,0x69,0x5f,0x70,0x6f,0x73,0x20,0x3a,0x20,
    ...
    0x32,0x20,0x3a,0x20,0x76,0x65,0x63,0x33,0x66,0x20,0x3d,0x20,0x69,0x5f,0x63,0x6f,
    ...
    0x38,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x20,0x3d,0x20,0x69,0x5f,0x70,0x6f,
    ...
    0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x28,0x31,0x29,0x20,0x69,0x5f,0x63,0x6f,0x6c,
    0x6f,0x72,0x5f,0x70,0x61,0x72,0x61,0x6d,0x20,0x3a,0x20,0x76,0x65,0x63,0x33,0x66,
    0x2c,0x20,0x40,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x28,0x30,0x29,0x20,0x69,
    ...
    0x7b,0x0a,0x20,0x20,0x69,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x69,0x5f,
    0x63,0x6f,0x6c,0x6f,0x72,0x5f,0x70,0x61,0x72,0x61,0x6d,0x3b,0x0a,0x20,0x20,0x69,
    0x5f,0x70,0x6f,0x73,0x20,0x3d,0x20,0x69,0x5f,0x70,0x6f,0x73,0x5f,0x70,0x61,0x72,
...
*/
pub const LINE_FS_SOURCE_WGSL: [u8; 366] = [
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
...
pub fn line_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    let mut desc = sg::ShaderDesc::new();
    desc.label = c"line_shader".as_ptr();
    match backend {
        sg::Backend::Glcore => {
            desc.vertex_func.source = &LINE_VS_SOURCE_GLSL430 as *const _ as *const _;
            desc.vertex_func.entry = c"main".as_ptr();
            desc.fragment_func.source = &LINE_FS_SOURCE_GLSL430 as *const _ as *const _;
            desc.fragment_func.entry = c"main".as_ptr();
            desc.attrs[0].glsl_name = c"i_pos".as_ptr();
            desc.attrs[1].glsl_name = c"i_color".as_ptr();
        ...
        sg::Backend::D3d11 => {
            desc.vertex_func.source = &LINE_VS_SOURCE_HLSL5 as *const _ as *const _;
            desc.vertex_func.d3d11_target = c"vs_5_0".as_ptr();
            desc.vertex_func.entry = c"main".as_ptr();
            desc.fragment_func.source = &LINE_FS_SOURCE_HLSL5 as *const _ as *const _;
        ...
        sg::Backend::Wgpu => {
            desc.vertex_func.source = &LINE_VS_SOURCE_WGSL as *const _ as *const _;
            desc.vertex_func.entry = c"main".as_ptr();
            desc.fragment_func.source = &LINE_FS_SOURCE_WGSL as *const _ as *const _;
            desc.fragment_func.entry = c"main".as_ptr();
            desc.uniform_blocks[0].stage = sg::ShaderStage::Vertex;
            desc.uniform_blocks[0].layout = sg::UniformLayout::Std140;
            desc.uniform_blocks[0].size = 16;
