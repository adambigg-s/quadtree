...
/*
    ...
    {
        f_color = v_color;
        gl_Position = vec4(fma(v_pos.x / v_params_world[0].x, 2.0, -1.0), fma(v_pos.y / v_params_world[0].y, 2.0, -1.0), 0.0, 1.0);
    }

*/
pub const SIMPLE_VS_SOURCE_GLSL430: [u8; 329] = [
...
/*
    ...
    {
        f_color = v_color;
        gl_Position = float4(mad(v_pos.x / _25_world_dims.x, 2.0f, -1.0f), mad(v_pos.y / _25_world_dims.y, 2.0f, -1.0f), 0.0f, 1.0f);
    }
...
*/
pub const SIMPLE_VS_SOURCE_HLSL5: [u8; 839] = [
    ...
    0x2c,0x20,0x2d,0x31,0x2e,0x30,0x66,0x29,0x2c,0x20,0x30,0x2e,0x30,0x66,0x2c,0x20,
...
/*
    ...
    fn main_1() {
      ...
      ndc = vec2f(x_47, x_48);
      let x_55 : vec2f = ndc;
      gl_Position = vec4f(x_55.x, x_55.y, 0.0f, 1.0f);
      return;
    }
...
*/
pub const SIMPLE_VS_SOURCE_WGSL: [u8; 1102] = [
