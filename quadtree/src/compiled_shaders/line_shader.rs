...
*/
pub const LINE_VS_SOURCE_GLSL430: [u8; 210] = [
    ...
    0x73,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x7d,0x0a,
    0x0a,0x00,
];
/*
    #version 430
...
/*
    ...
    {
        f_color = v_color;
        gl_Position = float4(v_pos, 1.0f, 1.0f);
    }
...
*/
pub const LINE_VS_SOURCE_HLSL5: [u8; 665] = [
...
/*
    ...
    fn main_1() {
      ...
      gl_Position = vec4f(x_25.x, x_25.y, 1.0f, 1.0f);
      return;
    }
...
*/
pub const LINE_VS_SOURCE_WGSL: [u8; 629] = [
    ...
    0x5f,0x32,0x35,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x66,0x2c,0x20,0x31,0x2e,0x30,
